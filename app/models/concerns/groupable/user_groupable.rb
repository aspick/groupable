module Groupable
  module UserGroupable
    ...
    included do
      ...
      if groups_assoc_name && groups_assoc_name != :groupable_groups && !method_defined?(groups_assoc_name)
      ...
      if (!groups_assoc_name || groups_assoc_name != :groups) && !method_defined?(:groups)
